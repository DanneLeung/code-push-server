...
config.development = {
  ...
  db: {
    ...
    password: process.env.RDS_PASSWORD || "dan7844",
  ...
  local: {
    ...
    storageDir: process.env.STORAGE_DIR || __dirname + "/../storage",
    // Binary files download host address which Code Push Server listen to. the files storage in storageDir.
    downloadUrl: process.env.LOCAL_DOWNLOAD_URL || "http://106.14.226.152:3300/download",
  ...
  jwt: {
    ...
    tokenSecret: process.env.TOKEN_SECRET ||'4akm5Nso8aAdVpIIr04UiE1vr8GKn30IVxEYdbMiReH8ZVCrloJzYcTZDSi6obr'
  },
  common: {
    /*
